...
while True:
    ...
    " mithilfe von WIKIPEDIA erstellt werden soll. Falls Sie die Zahl 1 eingeben, wird das Programm beendet.")
    if wert == "1":
        break
    assoziationsliste = []
